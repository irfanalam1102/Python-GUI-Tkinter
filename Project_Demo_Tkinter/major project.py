...
def _calender():
    try:
        speak("which years")
        cld = int(takeCommand())
        speak("its your output as your wish")
        print(calendar.calendar(cld))
        while True:
            if cld == False:
...
def name_():
    speak("her name is muskan she is one of the most crazy and mad girl in her age sagment ")
